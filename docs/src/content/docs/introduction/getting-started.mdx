...
- [Create Your First Experiment](/howto/create-first-experiment) - Step-by-step tutorial
- [Key Concepts](/concepts/overview) - Understand experiment, assignments, variant, cohorts etc.
...
:::tip[🎉 Success!]
Congratulations! You've successfully installed Ascend and [create your first experiment](/howto/create-first-experiment).

**Next steps:**
- [Configure SDK](/sdks/kotlin/installation) - Complete walkthrough
- [Key Concepts](/concepts/overview) - Understand key concepts experiments, audience, assignment etc.
- [How-To Contribute](/howto/how-to-contribute) - How to Contribute to Ascend
:::
