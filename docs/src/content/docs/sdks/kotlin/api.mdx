...
| Method | Return Type |
|--------|-------------|
| `getBooleanFlag(apiPath: String, variable: String)` | `Boolean` |
| `getIntFlag(apiPath: String, variable: String)` | `Int` |
| `getDoubleFlag(apiPath: String, variable: String)` | `Double` |
| `getLongFlag(apiPath: String, variable: String)` | `Long` |
| `getStringFlag(apiPath: String, variable: String)` | `String` |
| `getAllVariables(apiPath: String)` | `JsonObject?` |
...
**Parameters:**
- `apiPath`: The experiment identifier (e.g., "feature_toggle")
...
**Parameters:**
- `apiPath`: The experiment identifier (e.g., "retry_config")
...
**Parameters:**
- `apiPath`: The experiment identifier (e.g., "network_config")
...
**Parameters:**
- `apiPath`: The experiment identifier (e.g., "cache_config")
...
**Parameters:**
- `apiPath`: The experiment identifier (e.g., "button_exp_test")
...
**Parameters:**
- `apiPath`: The experiment identifier
...
**Parameters:**
- `map`: HashMap of experiment apiPaths with their default values
- `callback`: Callback interface for success/failure handling

**Behavior:**
- Appends the provided default values to the default map
- Triggers network requests to fetch the experiments - API CALL - getOnDemandData(newApiPaths, callback) -> getRemoteData(request, callback)
...
### 8. refreshExperiment
Fetches experiments using predefined apiPaths in the default map
